  ...
  return (
    <div className="mt-10 w-full px-5 sm:w-5/6 md:w-10/12 m-auto index-bg" id="projects">
      <div className="px-5  w-full md:w-4/6 my-5">
        <p className="text-green-500 text-3xl sm:text-5xl mb-4">Projects</p>
      ...
      <div className="text-white  flex items-center justify-center ">
        <div className="container mx-auto p-4">
          ...
          <p className="text-green-500 text-xl sm:text-3xl mb-4 my-10">Projects FullStack</p>
          ...
          <p className="text-green-500 text-xl sm:text-3xl mb-4 my-10">Projects Backend</p>
